...
function PickAndPlaceIllustration() {
  ...
  return (
    <div className="flex gap-4 md:gap-6 w-full max-w-lg mx-auto items-stretch" style={{ minHeight: 180 }}>
      ...
      >
        <div className="text-xs uppercase tracking-wider text-[#4a6a3a] mb-1">Elements</div>
        {categories.map((cat, i) => (
          ...
          >
            ...
            {i === 0 && (
              <div
                className="absolute -right-3 -top-3 w-6 h-6 flex items-center justify-center text-xs font-bold text-white"
                style={{
...
export default function SlidePickAndPlace() {
  return (
    <TutorialSlide
      ...
      body="Choose from the sidebar on the left. Each element shows its coin cost. Click on the map to place it!"
