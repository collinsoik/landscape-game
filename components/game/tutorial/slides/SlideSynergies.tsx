  ...
  return (
    <div className="flex flex-col sm:flex-row gap-6 md:gap-10 w-full max-w-lg mx-auto items-center justify-center">
      ...
      <div className="flex flex-col items-center gap-2">
        <div className="text-[10px] uppercase tracking-wider text-[#8bba6a] font-bold mb-1">
          Good Combo
        </div>
        <div className="relative flex items-center gap-3">
          ...
          <div className="flex flex-col items-center">
            ...
            />
            <span className="text-[9px] text-[#8bba6a] mt-1">Oak</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            />
            <span className="text-[9px] text-[#8bba6a] mt-1">Fern</span>
          </div>
        </div>
      ...
      {/* Bad combo */}
      <div className="flex flex-col items-center gap-2">
        <div className="text-[10px] uppercase tracking-wider text-[#c0392b] font-bold mb-1">
          Bad Combo
        </div>
        <div className="relative flex items-center gap-3">
          {/* Invasive vine */}
          <div className="flex flex-col items-center">
            ...
            />
            <span className="text-[9px] text-[#c0392b] mt-1">Vine</span>
          </div>
          ...
          <div className="flex flex-col items-center">
            ...
            />
            <span className="text-[9px] text-[#c94c8e] mt-1">Flower</span>
          </div>
        </div>
