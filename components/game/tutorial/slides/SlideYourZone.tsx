...
function YourZoneIllustration() {
  return (
    ...
    >
      ...
      >
        <div className="absolute top-1 left-2 text-[11px] text-[#4a6a3a55] uppercase tracking-wider">
          Team A
        </div>
      </div>
      ...
      >
        <div className="absolute top-1 left-2 text-xs text-[#8bba6a] uppercase tracking-wider font-bold">
          Your Zone!
        </div>
